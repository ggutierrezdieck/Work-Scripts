REM  Script will force start a job, and monitor until succes. Then it will force start next job and so on.
@echo off
...
:while
	...
	:next
	 if Not %status%==SUCCESS echo %currentJob% is %status% && goto loop
